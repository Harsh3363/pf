...
export default function Tokenomics() {
  return (
    <section className="container mx-auto py-10 ml-80">
      
    <div class="w-full max-w-sm p-4 bg-grey border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
        <h5 class="mb-3 text-base font-semibold text-gray-900 md:text-xl dark:text-grey">
            Connect wallet
        </h5>
        <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Buy EVO using BRISE.</p>
        <ul class="my-4 space-y-3">
            <li>
                <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-black">
        ...
        <div>
            <a href="https://linktr.ee/EmbrCheckout" class="inline-flex items-center text-xs font-normal text-gray-500 hover:underline dark:text-gray-400">
