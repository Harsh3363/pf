      ...
      <div className="grid md:grid-cols-2">
        ...
        <div className="w-10/12 md:w-7/12 lg:6/12 mx-auto relative py-20">
          ...
          <div className="border-l-2 mt-10">
            ...
            <div className="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-rose-700 text-black rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
              ...
              <div className="flex-auto">
                <h1 className="text-3xl m-7">Many more to come</h1>
